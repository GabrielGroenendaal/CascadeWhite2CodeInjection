...
#pragma region Enums
...
#endif
    {
        ...
        #if MOVE_EXPANSION
        MOVE561_POUND = 0x231,
        MOVE562_SCRATCH = 0x232,
        MOVE563_SWEET_KISS = 0x233,
        MOVE564_BUBBLE = 0x234,
        MOVE565_AQUA_CUTTER = 0x235,
        MOVE566_ROAR_OF_TIME = 0x236,
        MOVE567_SPACIAL_REND = 0x237,
        MOVE568_SACRED_FIRE = 0x238,
        MOVE569_BOLT_STRIKE = 0x239,
        MOVE570_HORN_ATTACK = 0x23A,
        MOVE571_FURY_ATTACK = 0x23B,
        MOVE572_EMBARGO = 0x23C,
        MOVE573_SHARPEN = 0x23D,
        MOVE574_FREEZE_SHOCK = 0x23E,
        MOVE575_ICE_BURN = 0x23F,
        MOVE576_MIST_BALL = 0x240,
        MOVE577_POUNCE = 0x241,
        MOVE578_WITHDRAW = 0x242,
        #endif
        #if MOVE_EXPANSION == 2
        MOVE579_MAGIC_ROOM = 0x243,
        MOVE580_FALSE_SWIPE = 0x244,
        MOVE581_SMACK_DOWN = 0x245,
        MOVE582_ODOR_SLEUTH = 0x246,
        MOVE583_LOCK_ON = 0x247,
        MOVE584_TRICK = 0x248,
        MOVE585_BIDE = 0x249,
        MOVE586_MULTIATTACK = 0x24A,
        MOVE587_MEMENTO = 0x24B,
        MOVE588_ROLE_PLAY = 0x24C,
        MOVE589_SPITE = 0x24D,
        MOVE590_SPLASH = 0x24E,
        MOVE591_THIEF = 0x24F,
        MOVE592_CAMOUFLAGE = 0x250,
        #endif 
    };
    ...
    enum AbilID : u8
    {
        ...
        ABIL072_RESILIENT = 0x48,
        ABIL073_STRONG_BODY = 0x49,
        ...
        ABIL161_COLLECTIVE = 0xA1,
        ABIL162_ILLUMINATE = 0xA2,
...
#pragma region ConstLists
    ...
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH}, // PK_NULL = 0x0,

    //     // KANTO
    //     { ABIL070_DROUGHT, ABIL034_CHLOROPHYLL, ABIL122_FLOWER_GIFT},        // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},1_BULBASAUR = 0x1,
    //     { ABIL070_DROUGHT, ABIL034_CHLOROPHYLL, ABIL122_FLOWER_GIFT},        // PK002_IVYSAUR = 0x2,
    //     { ABIL070_DROUGHT, ABIL034_CHLOROPHYLL, ABIL122_FLOWER_GIFT},        // PK003_VENUSAUR = 0x3,
    //     { ABIL070_DROUGHT, ABIL022_INTIMIDATE, ABIL163_TURBOBLAZE},          // PK004_CHARMANDER = 0x4,
    //     { ABIL070_DROUGHT, ABIL022_INTIMIDATE, ABIL163_TURBOBLAZE},          // PK005_CHARMELEON = 0x5,
    //     { ABIL070_DROUGHT, ABIL022_INTIMIDATE, ABIL163_TURBOBLAZE},          // PK006_CHARIZARD = 0x6,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL163_TURBOBLAZE},          // PK007_SQUIRTLE = 0x7,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL163_TURBOBLAZE},          // PK008_WARTORTLE = 0x8,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL163_TURBOBLAZE},          // PK009_BLASTOISE = 0x9,
    //     { ABIL107_ANTICIPATION, ABIL032_SERENE_GRACE, ABIL111_FILTER}, // PK010_CATERPIE = 0xA,
    //     { ABIL107_ANTICIPATION, ABIL032_SERENE_GRACE, ABIL111_FILTER}, // PK011_METAPOD = 0xB,
    //     { ABIL107_ANTICIPATION, ABIL032_SERENE_GRACE, ABIL027_EFFECT_SPORE}, // PK012_BUTTERFREE = 0xC,
    //     { ABIL097_SNIPER, ABIL107_ANTICIPATION, ABIL119_STAKEOUT},       // PK013_WEEDLE = 0xD,
    //     { ABIL097_SNIPER, ABIL107_ANTICIPATION, ABIL119_STAKEOUT},       // PK014_KAKUNA = 0xE,
    //     { ABIL097_SNIPER, ABIL107_ANTICIPATION, ABIL119_STAKEOUT},       // PK015_BEEDRILL = 0xF,
    //     { ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE}, // { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},016_PIDGEY = 0x10,
    //     { ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE}, // PK017_PIDGEOTTO = 0x1{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE}, // PK018_PIDGEOT = 0x12,
    //     { ABIL_NULL, ABIL_NULL, ABIL_NULL},                                  // PK019_RATTATA = 0x13,
    //     { ABIL_NULL, ABIL_NULL, ABIL_NULL},                                  // PK020_RATICATE = 0x14,
    //     { ABIL097_SNIPER, ABIL097_SNIPER, ABIL097_SNIPER},                   // PK021_SPEAROW = 0x15,
    //     { ABIL097_SNIPER, ABIL097_SNIPER, ABIL097_SNIPER},                   // PK022_FEAROW = 0x16,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL001_STENCH},             // PK023_EKANS = 0x17,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL001_STENCH},             // PK024_ARBOK = 0x18,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL009_STATIC},                       // PK025_PIKACHU = 0x19,
    //     { ABIL057_PLUS, ABIL008_SAND_VEIL, ABIL009_STATIC},                       // PK026_RAICHU = 0x1A,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},        // PK027_SANDSHREW = 0x1B,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},        // PK028_SANDSLASH = 0x1C,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK029_NIDORAN = 0x1D,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK030_NIDORINA = 0x1E,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL136_MULTISCALE},      // PK031_NIDOQUEEN = 0x1F,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK032_NIDORAN = 0x2{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},3_NIDORINO = 0x21,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK034_NIDOKING = 0x22,
    //     { ABIL086_SIMPLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                   // PK035_CLEFAIRY = 0x23,
    //     { ABIL086_SIMPLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                   // PK036_CLEFABLE = 0x24,
    //     { ABIL070_DROUGHT, ABIL149_ILLUSION, ABIL032_SERENE_GRACE},              // PK037_VULPIX = 0x25,
    //     { ABIL070_DROUGHT, ABIL149_ILLUSION, ABIL032_SERENE_GRACE},              // PK038_NINETALES = 0x26,
    //     { ABIL141_MOODY, ABIL017_FLUFFY, ABIL086_SIMPLE},                    // PK039_JIGGLYPUFF = 0x27,
    //     { ABIL141_MOODY, ABIL017_FLUFFY, ABIL086_SIMPLE},                    // PK040_WIGGLYTUFF = 0x28,
    //     { ABIL023_SHADOW_TAG, ABIL119_STAKEOUT, ABIL097_SNIPER},       // PK041_ZUBAT = 0x29,
    //     { ABIL023_SHADOW_TAG, ABIL119_STAKEOUT, ABIL097_SNIPER},       // PK042_GOLBAT = 0x2A,
    //     { ABIL001_STENCH, ABIL027_EFFECT_SPORE, ABIL070_DROUGHT},            // PK043_ODDISH = 0x2B,
    //     { ABIL001_STENCH, ABIL027_EFFECT_SPORE, ABIL070_DROUGHT},            // PK044_GLOOM = 0x2C,
    //     { ABIL001_STENCH, ABIL027_EFFECT_SPORE, ABIL070_DROUGHT},            // PK045_VILEPLUME = 0x2D,
    //     { ABIL027_EFFECT_SPORE, ABIL119_STAKEOUT, ABIL023_SHADOW_TAG},       // PK046_PARAS = 0x2E,
    //     { ABIL027_EFFECT_SPORE, ABIL119_STAKEOUT, ABIL023_SHADOW_TAG},       // PK047_PARASECT = 0x2F,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK048_VENONAT = 0x3{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},9_VENOMOTH = 0x31,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL008_SAND_VEIL},          // PK050_DIGLETT = 0x32,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL008_SAND_VEIL},          // PK051_DUGTRIO = 0x33,
    //     { ABIL124_PICKPOCKET, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},   // PK052_MEOWTH = 0x34,
    //     { ABIL124_PICKPOCKET, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},   // PK053_PERSIAN = 0x35,
    //     { ABIL002_DRIZZLE, ABIL107_ANTICIPATION, ABIL036_TRACE},             // PK054_PSYDUCK = 0x36,
    //     { ABIL002_DRIZZLE, ABIL107_ANTICIPATION, ABIL036_TRACE},             // PK055_GOLDUCK = 0x37,
    //     { ABIL055_HUSTLE, ABIL083_ANGER_POINT, ABIL110_TINTED_LENS},               // PK056_MANKEY = 0x38,
    //     { ABIL055_HUSTLE, ABIL083_ANGER_POINT, ABIL110_TINTED_LENS},               // PK057_PRIMEAPE = 0x39,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},                // PK058_GROWLITHE = 0x3A,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},                // PK059_ARCANINE = 0x3B,
    //     { ABIL002_DRIZZLE, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER},      // PK060_POLIWAG = 0x3C,
    //     { ABIL002_DRIZZLE, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER},      // PK061_POLIWHIRL = 0x3D,
    //     { ABIL002_DRIZZLE, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER},      // PK062_POLIWRATH = 0x3E,
    //     { ABIL107_ANTICIPATION, ABIL149_ILLUSION, ABIL145_SAVANT},           // PK063_ABRA = 0x3F,
    //     { ABIL107_ANTICIPATION, ABIL149_ILLUSION, ABIL145_SAVANT},           // PK064_KADABRA = 0x4{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL107_ANTICIPATION, ABIL149_ILLUSION, ABIL145_SAVANT},           // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},5_ALAKAZAM = 0x41,
    //     { ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER}, // PK066_MACHOP = 0x42,
    //     { ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER}, // PK067_MACHOKE = 0x43,
    //     { ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER, ABIL104_MOLD_BREAKER}, // PK068_MACHAMP = 0x44,
    //     { ABIL001_STENCH, ABIL119_STAKEOUT, ABIL071_ARENA_TRAP},             // PK069_BELLSPROUT = 0x45,
    //     { ABIL001_STENCH, ABIL119_STAKEOUT, ABIL071_ARENA_TRAP},             // PK070_WEEPINBELL = 0x46,
    //     { ABIL001_STENCH, ABIL119_STAKEOUT, ABIL071_ARENA_TRAP},             // PK071_VICTREEBEL = 0x47,
    //     { ABIL002_DRIZZLE, ABIL119_STAKEOUT, ABIL071_ARENA_TRAP},            // PK072_TENTACOOL = 0x48,
    //     { ABIL002_DRIZZLE, ABIL119_STAKEOUT, ABIL071_ARENA_TRAP},            // PK073_TENTACRUEL = 0x49,
    //     { ABIL106_AFTERMATH, ABIL045_SAND_STREAM, ABIL008_SAND_VEIL},        // PK074_GEODUDE = 0x4A,
    //     { ABIL106_AFTERMATH, ABIL045_SAND_STREAM, ABIL008_SAND_VEIL},        // PK075_GRAVELER = 0x4B,
    //     { ABIL106_AFTERMATH, ABIL116_SOLID_ROCK, ABIL008_SAND_VEIL},        // PK076_GOLEM = 0x4C,
    //     { ABIL070_DROUGHT, ABIL055_HUSTLE, ABIL032_SERENE_GRACE},            // PK077_PONYTA = 0x4D,
    //     { ABIL049_FLAME_BODY, ABIL055_HUSTLE, ABIL032_SERENE_GRACE},            // PK078_RAPIDASH = 0x4E,
    //     { ABIL002_DRIZZLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                  // PK079_SLOWPOKE = 0x4F,
    //     { ABIL002_DRIZZLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                  // PK080_SLOWBRO = 0x50,
    //     { ABIL135_LIGHT_METAL, ABIL057_PLUS, ABIL026_LEVITATE},                    // PK0{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_MAGNEMITE = 0x51,
    //     { ABIL135_LIGHT_METAL, ABIL057_PLUS, ABIL026_LEVITATE},                    // PK082_MAGNETON = 0x52,
    //     { ABIL020_QUICK_DRAW, ABIL055_HUSTLE, ABIL055_HUSTLE},               // PK083_FARFETCH_D = 0x53,
    //     { ABIL055_HUSTLE, ABIL141_MOODY, ABIL008_SAND_VEIL},            // PK084_DODUO = 0x54,
    //     { ABIL055_HUSTLE, ABIL141_MOODY, ABIL008_SAND_VEIL},            // PK085_DODRIO = 0x55,
    //     { ABIL117_SNOW_WARNING, ABIL031_LIGHTNING_ROD, ABIL081_SNOW_CLOAK},  // PK086_SEEL = 0x56,
    //     { ABIL117_SNOW_WARNING, ABIL031_LIGHTNING_ROD, ABIL081_SNOW_CLOAK},  // PK087_DEWGONG = 0x57,
    //     { ABIL001_STENCH, ABIL143_POISON_TOUCH, ABIL130_CURSED_BODY},       // PK088_GRIMER = 0x58,
    //     { ABIL001_STENCH, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH},       // PK089_MUK = 0x59,
    //     { ABIL020_QUICK_DRAW, ABIL106_AFTERMATH, ABIL117_SNOW_WARNING},      // PK090_SHELLDER = 0x5A,
    //     { ABIL020_QUICK_DRAW, ABIL106_AFTERMATH, ABIL117_SNOW_WARNING},      // PK091_CLOYSTER = 0x5B,
    //     { ABIL023_SHADOW_TAG, ABIL001_STENCH, ABIL123_BAD_DREAMS},             // PK092_GASTLY = 0x5C,
    //     { ABIL023_SHADOW_TAG, ABIL001_STENCH, ABIL123_BAD_DREAMS},             // PK093_HAUNTER = 0x5D,
    //     { ABIL023_SHADOW_TAG, ABIL001_STENCH, ABIL123_BAD_DREAMS},           // PK094_GENGAR = 0x5E,
    //     { ABIL045_SAND_STREAM, ABIL146_SAND_RUSH, ABIL008_SAND_VEIL},        // PK095_ONIX = 0x5F,
    //     { ABIL023_SHADOW_TAG, ABIL149_ILLUSION, ABIL158_PRANKSTER},           // PK096_DROWZEE = 0x6{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL023_SHADOW_TAG, ABIL149_ILLUSION, ABIL158_PRANKSTER},           //{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},K097_HYPNO = 0x61,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK098_KRABBY = 0x62,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK099_KINGLER = 0x63,
    //     { ABIL031_LIGHTNING_ROD, ABIL009_STATIC, ABIL106_AFTERMATH},                   // PK100_VOLTORB = 0x64,
    //     { ABIL031_LIGHTNING_ROD, ABIL009_STATIC, ABIL106_AFTERMATH},                   // PK101_ELECTRODE = 0x65,
    //     { ABIL139_GOURMAND, ABIL106_AFTERMATH, ABIL142_OVERCOAT},               // PK102_EXEGGCUTE = 0x66,
    //     { ABIL139_GOURMAND, ABIL106_AFTERMATH, ABIL142_OVERCOAT},               // PK103_EXEGGUTOR = 0x67,
    //     { ABIL020_QUICK_DRAW, ABIL045_SAND_STREAM, ABIL142_OVERCOAT},        // PK104_CUBONE = 0x68,
    //     { ABIL020_QUICK_DRAW, ABIL045_SAND_STREAM, ABIL142_OVERCOAT},        // PK105_MAROWAK = 0x69,
    //     { ABIL055_HUSTLE, ABIL073_STRONG_BODY, ABIL113_SCRAPPY},         // PK106_HITMONLEE = 0x6A,
    //     { ABIL055_HUSTLE, ABIL073_STRONG_BODY, ABIL113_SCRAPPY},         // PK107_HITMONCHAN = 0x6B,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK108_LICKITUNG = 0x6C,
    //     { ABIL106_AFTERMATH, ABIL020_QUICK_DRAW, ABIL001_STENCH},            // PK109_KOFFING = 0x6D,
    //     { ABIL106_AFTERMATH, ABIL020_QUICK_DRAW, ABIL001_STENCH},            // PK110_WEEZING = 0x6E,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL038_BERSERK},            // PK111_RHYHORN = 0x6F,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL038_BERSERK},            // PK112_RHYDON = 0x7{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL037_HUGE_POWER, ABIL037_HUGE_POWER, ABIL037_HUGE_POWER},       // PK113_CHANSEY = 0x7{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL034_CHLOROPHYLL, ABIL047_THICK_FAT, ABIL047_THICK_FAT},        // PK114_TANGELA = 0x72,
    //     { ABIL055_HUSTLE, ABIL083_ANGER_POINT, ABIL083_ANGER_POINT},                   // PK115_KANGASKHAN = 0x73,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL032_SERENE_GRACE},        // PK116_HORSEA = 0x74,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL032_SERENE_GRACE},        // PK117_SEADRA = 0x75,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK118_GOLDEEN = 0x76,
    ...
    //     { ABIL073_STRONG_BODY, ABIL005_STURDY, ABIL005_STURDY},              // PK123_SCYTHER = 0x7B,
    //     { ABIL117_SNOW_WARNING, ABIL149_ILLUSION, ABIL081_SNOW_CLOAK},       // PK124_JYNX = 0x7C,
    //     { ABIL089_IRON_FIST, ABIL083_ANGER_POINT, ABIL009_STATIC},                 // PK125_ELECTABUZZ = 0x7D,
    //     { ABIL020_QUICK_DRAW, ABIL070_DROUGHT, ABIL106_AFTERMATH},           // PK126_MAGMAR = 0x7E,
    //     { ABIL045_SAND_STREAM, ABIL022_INTIMIDATE, ABIL055_HUSTLE},          // PK127_PINSIR = 0x7F,
    //     { ABIL141_MOODY, ABIL038_BERSERK, ABIL055_HUSTLE},                   // PK128_TAUROS = 0x8{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL141_MOODY, ABIL002_DRIZZLE, ABIL033_SWIFT_SWIM},               // PK129_MAGIKARP = 0x8{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL141_MOODY, ABIL002_DRIZZLE, ABIL033_SWIFT_SWIM},               // PK130_GYARADOS = 0x82,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL032_SERENE_GRACE},         // PK131_LAPRAS = 0x83,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK132_DITTO = 0x84,
    //     { ABIL107_ANTICIPATION, ABIL141_MOODY, ABIL141_MOODY},               // PK133_EEVEE = 0x85,
    //     { ABIL107_ANTICIPATION, ABIL002_DRIZZLE, ABIL002_DRIZZLE},           // PK134_VAPOREON = 0x86,
    //     { ABIL107_ANTICIPATION, ABIL057_PLUS, ABIL058_MINUS},                // PK135_JOLTEON = 0x87,
    //     { ABIL107_ANTICIPATION, ABIL070_DROUGHT, ABIL049_FLAME_BODY},           // PK136_FLAREON = 0x88,
    //     { ABIL026_LEVITATE, ABIL026_LEVITATE, ABIL026_LEVITATE},             // PK137_PORYGON = 0x89,
    //     { ABIL033_SWIFT_SWIM, ABIL005_STURDY, ABIL005_STURDY},               // PK138_OMANYTE = 0x8A,
    //     { ABIL033_SWIFT_SWIM, ABIL005_STURDY, ABIL005_STURDY},               // PK139_OMASTAR = 0x8B,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK140_KABUTO = 0x8C,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK141_KABUTOPS = 0x8D,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL022_INTIMIDATE},       // PK142_AERODACTYL = 0x8E,
    //     { ABIL096_NORMALIZE, ABIL096_NORMALIZE, ABIL096_NORMALIZE},          // PK143_SNORLAX = 0x8F,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL081_SNOW_CLOAK},     // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},4_ARTICUNO = 0x90,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK145_ZAPDOS = 0x9{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},                // PK146_MOLTRES = 0x92,
    //     { ABIL047_THICK_FAT, ABIL033_SWIFT_SWIM, ABIL047_THICK_FAT},                   // PK147_DRATINI = 0x93,
    //     { ABIL047_THICK_FAT, ABIL033_SWIFT_SWIM, ABIL047_THICK_FAT},                   // PK148_DRAGONAIR = 0x94,
    //     { ABIL047_THICK_FAT, ABIL033_SWIFT_SWIM, ABIL047_THICK_FAT},                   // PK149_DRAGONITE = 0x95,
    //     { ABIL104_MOLD_BREAKER, ABIL127_UNNERVE, ABIL046_NEUTRALIZING_GAS},  // PK150_MEWTWO = 0x96,
    //     { ABIL104_MOLD_BREAKER, ABIL127_UNNERVE, ABIL046_NEUTRALIZING_GAS},  // PK151_MEW = 0x97,

    //     // JOHTO
    //     { ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT}, // PK152_CHIKORITA = 0x98,
    //     { ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT}, // PK153_BAYLEEF = 0x99,
    //     { ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT, ABIL122_FLOWER_GIFT}, // PK154_MEGANIUM = 0x9A,
    //     { ABIL070_DROUGHT, ABIL045_SAND_STREAM, ABIL146_SAND_RUSH},       // PK155_CYNDAQUIL = 0x9B,
    //     { ABIL070_DROUGHT, ABIL045_SAND_STREAM, ABIL146_SAND_RUSH},       // PK156_QUILAVA = 0x9C,
    //     { ABIL070_DROUGHT, ABIL045_SAND_STREAM, ABIL146_SAND_RUSH},       // PK157_TYPHLOSION = 0x9D,
    //     { ABIL002_DRIZZLE, ABIL119_STAKEOUT, ABIL022_INTIMIDATE},         // PK158_TOTODILE = 0x9E,
    //     { ABIL002_DRIZZLE, ABIL119_STAKEOUT, ABIL022_INTIMIDATE},         // PK159_CROCONAW = 0x9F,
    //     { ABIL002_DRIZZLE, ABIL119_STAKEOUT, ABIL022_INTIMIDATE},         // PK16{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},FERALIGATR = 0xA0,
    //     { ABIL119_STAKEOUT, ABIL119_STAKEOUT, ABIL119_STAKEOUT},          // PK161_SENTRET = 0xA{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL119_STAKEOUT, ABIL119_STAKEOUT, ABIL119_STAKEOUT},          // PK162_FURRET = 0xA2,
    //     { ABIL119_STAKEOUT, ABIL149_ILLUSION, ABIL023_SHADOW_TAG},        // PK163_HOOTHOOT = 0xA3,
    //     { ABIL119_STAKEOUT, ABIL149_ILLUSION, ABIL023_SHADOW_TAG},        // PK164_NOCTOWL = 0xA4,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK165_LEDYBA = 0xA5,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK166_LEDIAN = 0xA6,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL071_ARENA_TRAP},      // PK167_SPINARAK = 0xA7,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL071_ARENA_TRAP},      // PK168_ARIADOS = 0xA8,
    //     { ABIL023_SHADOW_TAG, ABIL119_STAKEOUT, ABIL097_SNIPER},    // PK169_CROBAT = 0xA9,
    //     { ABIL002_DRIZZLE, ABIL058_MINUS, ABIL057_PLUS},                  // PK170_CHINCHOU = 0xAA,
    //     { ABIL002_DRIZZLE, ABIL058_MINUS, ABIL057_PLUS},                  // PK171_LANTURN = 0xAB,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL009_STATIC},                    // PK172_PICHU = 0xAC,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK173_CLEFFA = 0xAD,
    //     { ABIL141_MOODY, ABIL017_FLUFFY, ABIL017_FLUFFY},                 // PK174_IGGLYBUFF = 0xAE,
    //     { ABIL131_HEALER, ABIL055_HUSTLE, ABIL131_HEALER},                // PK175_TOGEPI = 0xAF,
    //     { ABIL131_HEALER, ABIL055_HUSTLE, ABIL131_HEALER},                // PK176_TOGETIC = 0xB{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL149_ILLUSION, ABIL036_TRACE, ABIL036_TRACE},                //{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},PK177_NATU = 0xB1,
    //     { ABIL149_ILLUSION, ABIL036_TRACE, ABIL036_TRACE},                // PK178_XATU = 0xB2,
    //     { ABIL057_PLUS, ABIL017_FLUFFY, ABIL058_MINUS},                   // PK179_MAREEP = 0xB3,
    //     { ABIL057_PLUS, ABIL017_FLUFFY, ABIL058_MINUS},                   // PK180_FLAAFFY = 0xB4,
    //     { ABIL009_STATIC, ABIL017_FLUFFY, ABIL058_MINUS},                   // PK181_AMPHAROS = 0xB5,
    //     { ABIL027_EFFECT_SPORE, ABIL070_DROUGHT, ABIL122_FLOWER_GIFT},    // PK182_BELLOSSOM = 0xB6,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK183_MARILL = 0xB7,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK184_AZUMARILL = 0xB8,
    //     { ABIL045_SAND_STREAM, ABIL119_STAKEOUT, ABIL116_SOLID_ROCK},       // PK185_SUDOWOODO = 0xB9,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},             // PK186_POLITOED = 0xBA,
    //     { ABIL070_DROUGHT, ABIL086_SIMPLE, ABIL055_HUSTLE},               // PK187_HOPPIP = 0xBB,
    //     { ABIL070_DROUGHT, ABIL086_SIMPLE, ABIL055_HUSTLE},               // PK188_SKIPLOOM = 0xBC,
    //     { ABIL070_DROUGHT, ABIL086_SIMPLE, ABIL055_HUSTLE},               // PK189_JUMPLUFF = 0xBD,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK190_AIPOM = 0xBE,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},             // PK191_SUNKERN = 0xBF,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},             // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},2_SUNFLORA = 0xC0,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                //{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},K193_YANMA = 0xC1,
    //     { ABIL002_DRIZZLE, ABIL086_SIMPLE, ABIL086_SIMPLE},               // PK194_WOOPER = 0xC2,
    //     { ABIL002_DRIZZLE, ABIL086_SIMPLE, ABIL086_SIMPLE},               // PK195_QUAGSIRE = 0xC3,
    //     { ABIL107_ANTICIPATION, ABIL149_ILLUSION, ABIL039_INNER_FOCUS},   // PK196_ESPEON = 0xC4,
    //     { ABIL107_ANTICIPATION, ABIL119_STAKEOUT, ABIL143_POISON_TOUCH},      // PK197_UMBREON = 0xC5,
    //     { ABIL119_STAKEOUT, ABIL153_MOXIE, ABIL153_MOXIE},                // PK198_MURKROW = 0xC6,
    //     { ABIL002_DRIZZLE, ABIL086_SIMPLE, ABIL086_SIMPLE},               // PK199_SLOWKING = 0xC7,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG},      // PK200_MISDREAVUS = 0xC8,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG},      // PK201_UNOWN = 0xC9,
    //     { ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG},    // PK202_WOBBUFFET = 0xCA,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                   // PK203_GIRAFARIG = 0xCB,
    //     { ABIL106_AFTERMATH, ABIL020_QUICK_DRAW, ABIL005_STURDY},         // PK204_PINECO = 0xCC,
    //     { ABIL106_AFTERMATH, ABIL020_QUICK_DRAW, ABIL005_STURDY},         // PK205_FORRETRESS = 0xCD,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},     // PK206_DUNSPARCE = 0xCE,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL143_POISON_TOUCH},     // PK207_GLIGAR = 0xCF,
    //     { ABIL071_ARENA_TRAP, ABIL008_SAND_VEIL, ABIL005_STURDY},      // PK208_STEELIX = 0xD{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL062_GUTS, ABIL141_MOODY, ABIL083_ANGER_POINT},              // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},9_SNUBBULL = 0xD1,
    //     { ABIL062_GUTS, ABIL141_MOODY, ABIL083_ANGER_POINT},              // PK210_GRANBULL = 0xD2,
    //     { ABIL002_DRIZZLE, ABIL106_AFTERMATH, ABIL143_POISON_TOUCH},        // PK211_QWILFISH = 0xD3,
    //     { ABIL073_STRONG_BODY, ABIL005_STURDY, ABIL005_STURDY},           // PK212_SCIZOR = 0xD4,
    //     { ABIL045_SAND_STREAM, ABIL141_MOODY, ABIL141_MOODY},             // PK213_SHUCKLE = 0xD5,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK214_HERACROSS = 0xD6,
    //     { ABIL101_TECHNICIAN, ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK},  // PK215_SNEASEL = 0xD7,
    //     { ABIL045_SAND_STREAM, ABIL055_HUSTLE, ABIL055_HUSTLE},           // PK216_TEDDIURSA = 0xD8,
    ...
    //     { ABIL026_LEVITATE, ABIL140_ICE_SCALES, ABIL081_SNOW_CLOAK},           // PK225_DELIBIRD = 0xE{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL002_DRIZZLE, ABIL001_STENCH, ABIL001_STENCH},               // PK226_MANTINE = 0xE2,
    //     { ABIL015_THUNDER_ARMOR, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},   // PK227_SKARMORY = 0xE3,
    //     { ABIL163_TURBOBLAZE, ABIL022_INTIMIDATE, ABIL094_SOLAR_POWER},   // PK228_HOUNDOUR = 0xE4,
    //     { ABIL163_TURBOBLAZE, ABIL022_INTIMIDATE, ABIL094_SOLAR_POWER},   // PK229_HOUNDOOM = 0xE5,
    //     { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL032_SERENE_GRACE},     // PK230_KINGDRA = 0xE6,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL005_STURDY},        // PK231_PHANPY = 0xE7,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL005_STURDY},        // PK232_DONPHAN = 0xE8,
    //     { ABIL026_LEVITATE, ABIL026_LEVITATE, ABIL026_LEVITATE},          // PK233_PORYGON2 = 0xE9,
    //     { ABIL022_INTIMIDATE, ABIL149_ILLUSION, ABIL023_SHADOW_TAG},      // PK234_STANTLER = 0xEA,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                   // PK235_SMEARGLE = 0xEB,
    //     { ABIL055_HUSTLE, ABIL073_STRONG_BODY, ABIL073_STRONG_BODY},      // PK236_TYROGUE = 0xEC,
    //     { ABIL055_HUSTLE, ABIL073_STRONG_BODY, ABIL073_STRONG_BODY},      // PK237_HITMONTOP = 0xED,
    //     { ABIL117_SNOW_WARNING, ABIL149_ILLUSION, ABIL081_SNOW_CLOAK},    // PK238_SMOOCHUM = 0xEE,
    //     { ABIL058_MINUS, ABIL083_ANGER_POINT, ABIL057_PLUS},              // PK239_ELEKID = 0xEF,
    //     { ABIL020_QUICK_DRAW, ABIL070_DROUGHT, ABIL106_AFTERMATH},        //{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},K240_MAGBY = 0xF0,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // P{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},41_MILTANK = 0xF1,
    //     { ABIL037_HUGE_POWER, ABIL037_HUGE_POWER, ABIL037_HUGE_POWER},    // PK242_BLISSEY = 0xF2,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK243_RAIKOU = 0xF3,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK244_ENTEI = 0xF4,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK245_SUICUNE = 0xF5,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL116_SOLID_ROCK},         // PK246_LARVITAR = 0xF6,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL116_SOLID_ROCK},         // PK247_PUPITAR = 0xF7,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL116_SOLID_ROCK},         // PK248_TYRANITAR = 0xF8,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK249_LUGIA = 0xF9,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK250_HO_OH = 0xFA,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                // PK251_CELEBI = 0xFB,

    //     // HOENN
    //     { ABIL107_ANTICIPATION, ABIL097_SNIPER, ABIL094_SOLAR_POWER},        // PK252_TREECKO = 0xFC,
    //     { ABIL107_ANTICIPATION, ABIL097_SNIPER, ABIL094_SOLAR_POWER},        // PK253_GROVYLE = 0xFD,
    //     { ABIL107_ANTICIPATION, ABIL097_SNIPER, ABIL094_SOLAR_POWER},        // PK254_SCEPTILE = 0xFE,
    //     { ABIL003_SPEED_BOOST, ABIL070_DROUGHT, ABIL055_HUSTLE},             // PK255_TORCHIC = 0xFF,
    //     { ABIL003_SPEED_BOOST, ABIL070_DROUGHT, ABIL055_HUSTLE},             // PK25{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},COMBUSKEN = 0x100,
    //     { ABIL003_SPEED_BOOST, ABIL070_DROUGHT, ABIL055_HUSTLE},             // PK257_BLAZIKEN = 0x10{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL002_DRIZZLE, ABIL045_SAND_STREAM, ABIL107_ANTICIPATION},       // PK258_MUDKIP = 0x102,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL107_ANTICIPATION},       // PK259_MARSHTOMP = 0x103,
    //     { ABIL002_DRIZZLE, ABIL045_SAND_STREAM, ABIL107_ANTICIPATION},       // PK260_SWAMPERT = 0x104,
    //     { ABIL119_STAKEOUT, ABIL119_STAKEOUT, ABIL119_STAKEOUT},             // PK261_POOCHYENA = 0x105,
    //     { ABIL119_STAKEOUT, ABIL119_STAKEOUT, ABIL119_STAKEOUT},             // PK262_MIGHTYENA = 0x106,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK263_ZIGZAGOON = 0x107,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK264_LINOONE = 0x108,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK265_WURMPLE = 0x109,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK266_SILCOON = 0x10A,
    //     { ABIL107_ANTICIPATION, ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE}, // PK267_BEAUTIFLY = 0x10B,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK268_CASCOON = 0x10C,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK269_DUSTOX = 0x10D,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK270_LOTAD = 0x10E,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK271_LOMBRE = 0x10F,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK2{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_LUDICOLO = 0x110,
    //     { ABIL070_DROUGHT, ABIL106_AFTERMATH, ABIL107_ANTICIPATION},         // P{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},73_SEEDOT = 0x111,
    //     { ABIL051_WIND_RIDER, ABIL106_AFTERMATH, ABIL107_ANTICIPATION},         // PK274_NUZLEAF = 0x112,
    //     { ABIL070_DROUGHT, ABIL106_AFTERMATH, ABIL107_ANTICIPATION},         // PK275_SHIFTRY = 0x113,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK276_TAILLOW = 0x114,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK277_SWELLOW = 0x115,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK278_WINGULL = 0x116,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK279_PELIPPER = 0x117,
    //     { ABIL149_ILLUSION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},     // PK280_RALTS = 0x118,
    //     { ABIL149_ILLUSION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},     // PK281_KIRLIA = 0x119,
    //     { ABIL149_ILLUSION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},     // PK282_GARDEVOIR = 0x11A,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK283_SURSKIT = 0x11B,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK284_MASQUERAIN = 0x11C,
    //     { ABIL001_STENCH, ABIL027_EFFECT_SPORE, ABIL027_EFFECT_SPORE},       // PK285_SHROOMISH = 0x11D,
    //     { ABIL001_STENCH, ABIL027_EFFECT_SPORE, ABIL027_EFFECT_SPORE},       // PK286_BRELOOM = 0x11E,
    //     { ABIL062_GUTS, ABIL073_STRONG_BODY, ABIL109_UNAWARE},               // PK287_SLAKOTH = 0x11F,
    //     { ABIL062_GUTS, ABIL073_STRONG_BODY, ABIL109_UNAWARE},               // PK2{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_VIGOROTH = 0x120,
    //     { ABIL062_GUTS, ABIL073_STRONG_BODY, ABIL109_UNAWARE},               // PK289_SLAKING = 0x12{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL119_STAKEOUT, ABIL097_SNIPER, ABIL045_SAND_STREAM},                 // PK290_NINCADA = 0x122,
    //     { ABIL119_STAKEOUT, ABIL097_SNIPER, ABIL045_SAND_STREAM},                 // PK291_NINJASK = 0x123,
    //     { ABIL119_STAKEOUT, ABIL097_SNIPER, ABIL025_WONDER_GUARD},           // PK292_SHEDINJA = 0x124,
    //     { ABIL141_MOODY, ABIL083_ANGER_POINT, ABIL113_SCRAPPY},              // PK293_WHISMUR = 0x125,
    //     { ABIL141_MOODY, ABIL083_ANGER_POINT, ABIL113_SCRAPPY},              // PK294_LOUDRED = 0x126,
    //     { ABIL141_MOODY, ABIL083_ANGER_POINT, ABIL113_SCRAPPY},              // PK295_EXPLOUD = 0x127,
    //     { ABIL113_SCRAPPY, ABIL113_SCRAPPY, ABIL113_SCRAPPY},                // PK296_MAKUHITA = 0x128,
    //     { ABIL113_SCRAPPY, ABIL113_SCRAPPY, ABIL113_SCRAPPY},                // PK297_HARIYAMA = 0x129,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK298_AZURILL = 0x12A,
    //     { ABIL045_SAND_STREAM, ABIL010_VOLT_ABSORB, ABIL116_SOLID_ROCK},    // PK299_NOSEPASS = 0x12B,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                      // PK300_SKITTY = 0x12C,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                      // PK301_DELCATTY = 0x12D,
    //     { ABIL119_STAKEOUT, ABIL023_SHADOW_TAG, ABIL158_PRANKSTER},         // PK302_SABLEYE = 0x12E,
    //     { ABIL037_HUGE_POWER, ABIL071_ARENA_TRAP, ABIL119_STAKEOUT},       // PK303_MAWILE = 0x12F,
    //     { ABIL135_LIGHT_METAL, ABIL134_HEAVY_METAL, ABIL001_STENCH},                   //{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},K304_ARON = 0x130,
    //     { ABIL135_LIGHT_METAL, ABIL134_HEAVY_METAL, ABIL001_STENCH},                   // PK305_LAIRON = 0x13{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL135_LIGHT_METAL, ABIL134_HEAVY_METAL, ABIL001_STENCH},                   // PK306_AGGRON = 0x132,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK307_MEDITITE = 0x133,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK308_MEDICHAM = 0x134,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL009_STATIC},                       // PK309_ELECTRIKE = 0x135,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL009_STATIC},                       // PK310_MANECTRIC = 0x136,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL078_MOTOR_DRIVE},                       // PK311_PLUSLE = 0x137,
    //     { ABIL058_MINUS, ABIL057_PLUS, ABIL078_MOTOR_DRIVE},                        // PK312_MINUN = 0x138,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK313_VOLBEAT = 0x139,
    //     { ABIL058_MINUS, ABIL057_PLUS, ABIL057_PLUS},                        // PK314_ILLUMISE = 0x13A,
    //     { ABIL001_STENCH, ABIL032_SERENE_GRACE, ABIL001_STENCH},                   // PK315_ROSELIA = 0x13B,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK316_GULPIN = 0x13C,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK317_SWALOT = 0x13D,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                //  PK318_CARVANHA = 0x13E,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                //  PK319_SHARPEDO = 0x13F,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                //   PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},0_WAILMER = 0x140,
    //     { ABIL002_DRIZZLE, ABIL105_MOISTURIZE, ABIL080_COLOSSAL},            //   PK321_WAILORD = 0x14{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL106_AFTERMATH, ABIL086_SIMPLE, ABIL070_DROUGHT},               //   PK322_NUMEL = 0x142,
    //     { ABIL106_AFTERMATH, ABIL086_SIMPLE, ABIL070_DROUGHT},               //   PK323_CAMERUPT = 0x143,
    //     { ABIL106_AFTERMATH, ABIL086_SIMPLE, ABIL070_DROUGHT},               //  PK324_TORKOAL = 0x144,
    //     { ABIL141_MOODY, ABIL036_TRACE, ABIL036_TRACE},                      // PK325_SPOINK = 0x145,
    //     { ABIL141_MOODY, ABIL036_TRACE, ABIL036_TRACE},                      // PK326_GRUMPIG = 0x146,
    //     { ABIL141_MOODY, ABIL113_SCRAPPY, ABIL141_MOODY},                      //   PK327_SPINDA = 0x147,
    //     { ABIL045_SAND_STREAM, ABIL146_SAND_RUSH, ABIL008_SAND_VEIL},        // PK328_TRAPINCH = 0x148,
    //     { ABIL045_SAND_STREAM, ABIL146_SAND_RUSH, ABIL008_SAND_VEIL},        // PK329_VIBRAVA = 0x149,
    //     { ABIL045_SAND_STREAM, ABIL146_SAND_RUSH, ABIL008_SAND_VEIL},        // PK330_FLYGON = 0x14A,
    //     { ABIL119_STAKEOUT, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},           //  PK331_CACNEA = 0x14B,
    //     { ABIL119_STAKEOUT, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},           //  PK332_CACTURNE = 0x14C,
    //     { ABIL040_PIXILATE, ABIL142_OVERCOAT, ABIL032_SERENE_GRACE},               //   PK333_SWABLU = 0x14D,
    //     { ABIL017_FLUFFY, ABIL142_OVERCOAT, ABIL032_SERENE_GRACE},               //   PK334_ALTARIA = 0x14E,
    //     { ABIL119_STAKEOUT, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},                   //   PK335_ZANGOOSE = 0x14F,
    //     { ABIL007_CORROSION, ABIL093_STRONG_JAW, ABIL119_STAKEOUT},                   //  PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},6_SEVIPER = 0x150,
    ...
    //     { ABIL038_BERSERK, ABIL045_SAND_STREAM, ABIL091_ADAPTABILITY},        // PK339_BARBOACH = 0x153,
    //     { ABIL038_BERSERK, ABIL045_SAND_STREAM, ABIL091_ADAPTABILITY},        // PK340_WHISCASH = 0x154,
    ...
    //     { ABIL045_SAND_STREAM, ABIL003_SPEED_BOOST, ABIL071_ARENA_TRAP},     //   PK344_CLAYDOL = 0x158,
    //     { ABIL045_SAND_STREAM, ABIL119_STAKEOUT, ABIL008_SAND_VEIL},         // PK345_LILEEP = 0x159,
    //     { ABIL045_SAND_STREAM, ABIL119_STAKEOUT, ABIL008_SAND_VEIL},         // PK346_CRADILY = 0x15A,
    //     { ABIL033_SWIFT_SWIM, ABIL045_SAND_STREAM, ABIL008_SAND_VEIL},       // PK347_ANORITH = 0x15B,
    //     { ABIL033_SWIFT_SWIM, ABIL045_SAND_STREAM, ABIL008_SAND_VEIL},       // PK348_ARMALDO = 0x15C,
    //     { ABIL002_DRIZZLE, ABIL032_SERENE_GRACE, ABIL032_SERENE_GRACE},      // PK349_FEEBAS = 0x15D,
    //     { ABIL002_DRIZZLE, ABIL032_SERENE_GRACE, ABIL061_SHED_SKIN},      // PK350_MILOTIC = 0x15E,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK351_CASTFORM = 0x15F,
    //     { ABIL023_SHADOW_TAG, ABIL107_ANTICIPATION, ABIL149_ILLUSION},       //  PK352_KECLEON = 0x16{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL023_SHADOW_TAG, ABIL083_ANGER_POINT, ABIL130_CURSED_BODY},       //  PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},3_SHUPPET = 0x161,
    //     { ABIL023_SHADOW_TAG, ABIL083_ANGER_POINT, ABIL130_CURSED_BODY},       //   PK354_BANETTE = 0x162,
    //     { ABIL023_SHADOW_TAG, ABIL107_ANTICIPATION, ABIL130_CURSED_BODY},       //   PK355_DUSKULL = 0x163,
    //     { ABIL023_SHADOW_TAG, ABIL107_ANTICIPATION, ABIL130_CURSED_BODY},       //   PK356_DUSCLOPS = 0x164,
    //     { ABIL047_THICK_FAT, ABIL027_EFFECT_SPORE, ABIL027_EFFECT_SPORE},                   // PK357_TROPIUS = 0x165,
    //     { ABIL047_THICK_FAT, ABIL027_EFFECT_SPORE, ABIL047_THICK_FAT},                   //   PK358_CHIMECHO = 0x166,
    //     { ABIL107_ANTICIPATION, ABIL119_STAKEOUT, ABIL097_SNIPER},           // PK359_ABSOL = 0x167,
    //     { ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG},       //   PK360_WYNAUT = 0x168,
    //     { ABIL005_STURDY, ABIL141_MOODY, ABIL117_SNOW_WARNING},              //   PK361_SNORUNT = 0x169,
    //     { ABIL005_STURDY, ABIL141_MOODY, ABIL106_AFTERMATH},                 //   PK362_GLALIE = 0x16A,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL102_FUR_COAT},       // PK363_SPHEAL = 0x16B,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL102_FUR_COAT},       // PK364_SEALEO = 0x16C,
    //     { ABIL022_INTIMIDATE, ABIL081_SNOW_CLOAK, ABIL102_FUR_COAT},       // PK365_WALREIN = 0x16D,
    //     { ABIL002_DRIZZLE, ABIL033_SWIFT_SWIM, ABIL033_SWIFT_SWIM},          // PK366_CLAMPERL = 0x16E,
    //     { ABIL002_DRIZZLE, ABIL033_SWIFT_SWIM, ABIL033_SWIFT_SWIM},          // PK367_HUNTAIL = 0x16F,
    //     { ABIL002_DRIZZLE, ABIL033_SWIFT_SWIM, ABIL033_SWIFT_SWIM},          // PK368_GOREBYSS = 0x17{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL045_SAND_STREAM, ABIL002_DRIZZLE, ABIL002_DRIZZLE},            // PK36{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},RELICANTH = 0x171,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK370_LUVDISC = 0x172,
    //     { ABIL153_MOXIE, ABIL060_AERILATE, ABIL060_AERILATE},                // PK371_BAGON = 0x173,
    //     { ABIL153_MOXIE, ABIL060_AERILATE, ABIL060_AERILATE},                // PK372_SHELGON = 0x174,
    //     { ABIL153_MOXIE, ABIL060_AERILATE, ABIL060_AERILATE},                // PK373_SALAMENCE = 0x175,
    //     { ABIL003_SPEED_BOOST, ABIL134_HEAVY_METAL, ABIL134_HEAVY_METAL},    //   PK374_BELDUM = 0x176,
    //     { ABIL003_SPEED_BOOST, ABIL134_HEAVY_METAL, ABIL134_HEAVY_METAL},    //   PK375_METANG = 0x177,
    //     { ABIL003_SPEED_BOOST, ABIL134_HEAVY_METAL, ABIL134_HEAVY_METAL},    //   PK376_METAGROSS = 0x178,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK377_REGIROCK = 0x179,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK378_REGICE = 0x17A,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK379_REGISTEEL = 0x17B,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK380_LATIAS = 0x17C,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK381_LATIOS = 0x17D,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK382_KYOGRE = 0x17E,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK383_GROUDON = 0x17F,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK3{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_RAYQUAZA = 0x180,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK385_JIRACHI = 0x18{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK386_DEOXYS = 0x182,

    //     // SINNOH
    //     { ABIL005_STURDY, ABIL047_THICK_FAT, ABIL022_INTIMIDATE},            // PK387_TURTWIG = 0x183,
    //     { ABIL005_STURDY, ABIL047_THICK_FAT, ABIL022_INTIMIDATE},            // PK388_GROTLE = 0x184,
    //     { ABIL005_STURDY, ABIL047_THICK_FAT, ABIL022_INTIMIDATE},            // PK389_TORTERRA = 0x185,
    //     { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL049_FLAME_BODY},      //  PK390_CHIMCHAR = 0x186,
    //     { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL049_FLAME_BODY},      //  PK391_MONFERNO = 0x187,
    //     { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL049_FLAME_BODY},      //  PK392_INFERNAPE = 0x188,
    //     { ABIL031_LIGHTNING_ROD, ABIL002_DRIZZLE, ABIL081_SNOW_CLOAK},       //  PK393_PIPLUP = 0x189,
    //     { ABIL031_LIGHTNING_ROD, ABIL002_DRIZZLE, ABIL081_SNOW_CLOAK},       //  PK394_PRINPLUP = 0x18A,
    //     { ABIL031_LIGHTNING_ROD, ABIL115_ICE_BODY, ABIL081_SNOW_CLOAK},       //   PK395_EMPOLEON = 0x18B,
    //     { ABIL055_HUSTLE, ABIL113_SCRAPPY, ABIL113_SCRAPPY},                   //   PK396_STARLY = 0x18C,
    //     { ABIL055_HUSTLE, ABIL113_SCRAPPY, ABIL113_SCRAPPY},                   //    PK397_STARAVIA = 0x18D,
    //     { ABIL055_HUSTLE, ABIL113_SCRAPPY, ABIL113_SCRAPPY},                   //    PK398_STARAPTOR = 0x18E,
    //     { ABIL086_SIMPLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                   //   PK399_BIDOOF = 0x18F,
    //     { ABIL086_SIMPLE, ABIL086_SIMPLE, ABIL086_SIMPLE},                   //  PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},0_BIBAREL = 0x190,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK401_KRICKETOT = 0x19{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK402_KRICKETUNE = 0x192,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK403_SHINX = 0x193,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK404_LUXIO = 0x194,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK405_LUXRAY = 0x195,
    //     { ABIL001_STENCH, ABIL032_SERENE_GRACE, ABIL001_STENCH},                   // PK406_BUDEW = 0x196,
    //     { ABIL001_STENCH, ABIL032_SERENE_GRACE, ABIL001_STENCH},                   // PK407_ROSERADE = 0x197,
    //     { ABIL069_ROCK_HEAD, ABIL005_STURDY, ABIL146_SAND_RUSH},           // PK408_CRANIDOS = 0x198,
    //     { ABIL069_ROCK_HEAD, ABIL005_STURDY, ABIL146_SAND_RUSH},           // PK409_RAMPARDOS = 0x199,
    //     { ABIL045_SAND_STREAM, ABIL005_STURDY, ABIL116_SOLID_ROCK},          // PK410_SHIELDON = 0x19A,
    //     { ABIL045_SAND_STREAM, ABIL005_STURDY, ABIL116_SOLID_ROCK},          // PK411_BASTIODON = 0x19B,
    //     { ABIL107_ANTICIPATION, ABIL050_RUN_AWAY, ABIL050_RUN_AWAY},         //   PK412_BURMY = 0x19C,
    //     { ABIL107_ANTICIPATION, ABIL005_STURDY, ABIL142_OVERCOAT},             //   PK413_WORMADAM = 0x19D,
    //     { ABIL107_ANTICIPATION, ABIL110_TINTED_LENS, ABIL027_EFFECT_SPORE}, //   PK414_MOTHIM = 0x19E,
    //     { ABIL022_INTIMIDATE, ABIL022_INTIMIDATE, ABIL022_INTIMIDATE},       // PK415_COMBEE = 0x19F,
    //     { ABIL022_INTIMIDATE, ABIL022_INTIMIDATE, ABIL022_INTIMIDATE},       // PK416_VESPIQUEN = 0x1A{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL057_PLUS, ABIL158_PRANKSTER, ABIL102_FUR_COAT},                    // PK41{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},PACHIRISU = 0x1A1,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK418_BUIZEL = 0x1A2,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK419_FLOATZEL = 0x1A3,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK420_CHERUBI = 0x1A4,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK421_CHERRIM = 0x1A5,
    //     { ABIL002_DRIZZLE, ABIL045_SAND_STREAM, ABIL001_STENCH},             // PK422_SHELLOS = 0x1A6,
    //     { ABIL002_DRIZZLE, ABIL045_SAND_STREAM, ABIL001_STENCH},             // PK423_GASTRODON = 0x1A7,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK424_AMBIPOM = 0x1A8,
    //     { ABIL106_AFTERMATH, ABIL051_WIND_RIDER, ABIL031_LIGHTNING_ROD},     // PK425_DRIFLOON = 0x1A9,
    //     { ABIL106_AFTERMATH, ABIL051_WIND_RIDER, ABIL031_LIGHTNING_ROD},     // PK426_DRIFBLIM = 0x1AA,
    //     { ABIL141_MOODY, ABIL017_FLUFFY, ABIL017_FLUFFY},                    // PK427_BUNEARY = 0x1AB,
    //     { ABIL141_MOODY, ABIL017_FLUFFY, ABIL017_FLUFFY},                    // PK428_LOPUNNY = 0x1AC,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL023_SHADOW_TAG},         //   PK429_MISMAGIUS = 0x1AD,
    //     { ABIL119_STAKEOUT, ABIL153_MOXIE, ABIL158_PRANKSTER},                   // PK430_HONCHKROW = 0x1AE,
    //     { ABIL141_MOODY, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},        // PK431_GLAMEOW = 0x1AF,
    //     { ABIL141_MOODY, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},        // PK432_PURUGLY = 0x1B{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK433_CHINGLING = 0x1B{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL106_AFTERMATH, ABIL001_STENCH, ABIL020_QUICK_DRAW},            //  PK434_STUNKY = 0x1B2,
    //     { ABIL106_AFTERMATH, ABIL001_STENCH, ABIL020_QUICK_DRAW},            //   PK435_SKUNTANK = 0x1B3,
    ...
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL159_SAND_FORCE},       //   PK443_GIBLE = 0x1BB,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL159_SAND_FORCE},       //  PK444_GABITE = 0x1BC,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL159_SAND_FORCE},       //   PK445_GARCHOMP = 0x1BD,
    //     { ABIL096_NORMALIZE, ABIL096_NORMALIZE, ABIL096_NORMALIZE},          // PK446_MUNCHLAX = 0x1BE,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK447_RIOLU = 0x1BF,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK448_LUCARIO = 0x1C0,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL045_SAND_STREAM},      //  PK449_HIPPOPOTAS = 0x1C0},
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL045_SAND_STREAM},      //  PK450_HIPPOWDON = 0x1C2,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK451_SKORUPI = 0x1C3,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK452_DRAPION = 0x1C4,
    //     { ABIL033_SWIFT_SWIM, ABIL107_ANTICIPATION, ABIL143_POISON_TOUCH},   //   PK453_CROAGUNK = 0x1C5,
    //     { ABIL033_SWIFT_SWIM, ABIL107_ANTICIPATION, ABIL143_POISON_TOUCH},   //   PK454_TOXICROAK = 0x1C6,
    //     { ABIL071_ARENA_TRAP, ABIL119_STAKEOUT, ABIL119_STAKEOUT},           //   PK455_CARNIVINE = 0x1C7,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK456_FINNEON = 0x1C8,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK457_LUMINEON = 0x1C9,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK458_MANTYKE = 0x1CA,
    //     { ABIL117_SNOW_WARNING, ABIL077_SLUSH_RUSH, ABIL081_SNOW_CLOAK},     //   PK459_SNOVER = 0x1CB,
    //     { ABIL117_SNOW_WARNING, ABIL077_SLUSH_RUSH, ABIL081_SNOW_CLOAK},     //   PK460_ABOMASNOW = 0x1CC,
    //     { ABIL101_TECHNICIAN, ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK},     // PK461_WEAVILE = 0x1CD,
    //     { ABIL135_LIGHT_METAL, ABIL057_PLUS, ABIL026_LEVITATE},                    // PK462_MAGNEZONE = 0x1CE,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK463_LICKILICKY = 0x1CF,
    //     { ABIL045_SAND_STREAM, ABIL038_BERSERK, ABIL038_BERSERK},            // PK464_RHYPERIOR = 0x1D0,
    //     { ABIL034_CHLOROPHYLL, ABIL047_THICK_FAT, ABIL047_THICK_FAT},        // PK460,TANGROWTH = 0x1D1,
    //     { ABIL009_STATIC, ABIL083_ANGER_POINT, ABIL042_MAGNET_PULL},                 // PK466_ELECTIVIRE = 0x1D2,
    //     { ABIL020_QUICK_DRAW, ABIL070_DROUGHT, ABIL106_AFTERMATH},           //  PK467_MAGMORTAR = 0x1D3,
    //     { ABIL131_HEALER, ABIL055_HUSTLE, ABIL131_HEALER},                   // PK468_TOGEKISS = 0x1D4,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK469_YANMEGA = 0x1D5,
    //     { ABIL107_ANTICIPATION, ABIL110_TINTED_LENS, ABIL122_FLOWER_GIFT},       //  PK470_LEAFEON = 0x1D6,
    //     { ABIL085_HEATPROOF, ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK},   //   PK471_GLACEON = 0x1D7,
    //     { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL143_POISON_TOUCH},        // PK472_GLISCOR = 0x1D8,
    //     { ABIL038_BERSERK, ABIL081_SNOW_CLOAK, ABIL077_SLUSH_RUSH},    //  PK473_MAMOSWINE = 0x1D9,
    ...
    //     { ABIL023_SHADOW_TAG, ABIL107_ANTICIPATION, ABIL130_CURSED_BODY},       //   PK477_DUSKNOIR = 0x1DD,
    //     { ABIL081_SNOW_CLOAK, ABIL117_SNOW_WARNING, ABIL032_SERENE_GRACE},       //    PK478_FROSLASS = 0x1DE,
    //     { ABIL149_ILLUSION, ABIL057_PLUS, ABIL023_SHADOW_TAG},               //    PK479_ROTOM = 0x1DF,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK480_UXIE = 0x1E0,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK481_MESPRIT = 0x1E0,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK482_AZELF = 0x1E2,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK483_DIALGA = 0x1E3,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK484_PALKIA = 0x1E4,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK485_HEATRAN = 0x1E5,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK486_REGIGIGAS = 0x1E6,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK487_GIRATINA = 0x1E7,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK488_CRESSELIA = 0x1E8,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK489_PHIONE = 0x1E9,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //    PK490_MANAPHY = 0x1EA,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK491_DARKRAI = 0x1EB,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK492_SHAYMIN = 0x1EC,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK493_ARCEUS = 0x1ED,

    //     // UNOVA
    //     { ABIL126_CONTRARY, ABIL126_CONTRARY, ABIL126_CONTRARY},             // PK494_VICTINI = 0x1EE,
    //     { ABIL065_OVERGROW, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK495_SNIVY = 0x1EF,
    //     { ABIL065_OVERGROW, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK496_SERVINE = 0x1F0,
    //     { ABIL065_OVERGROW, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK497_SERPERIOR = 0x1F1,
    //     { ABIL066_BLAZE, ABIL125_SHEER_FORCE, ABIL070_DROUGHT},                // PK498_TEPIG = 0x1F2,
    //     { ABIL066_BLAZE, ABIL125_SHEER_FORCE, ABIL070_DROUGHT},                // PK499_PIGNITE = 0x1F3,
    //     { ABIL066_BLAZE, ABIL125_SHEER_FORCE, ABIL070_DROUGHT},                // PK500_EMBOAR = 0x1F4,
    //     { ABIL067_TORRENT, ABIL020_QUICK_DRAW, ABIL128_DEFIANT},             // PK501_OSHAWOTT = 0x1F5,
    //     { ABIL067_TORRENT, ABIL020_QUICK_DRAW, ABIL128_DEFIANT},             // PK502_DEWOTT = 0x1F6,
    //     { ABIL067_TORRENT, ABIL020_QUICK_DRAW, ABIL128_DEFIANT},             // PK503_SAMUROTT = 0x1F7,
    //     { ABIL107_ANTICIPATION, ABIL119_STAKEOUT, ABIL119_STAKEOUT},         // PK504_PATRAT = 0x1F8,
    //     { ABIL107_ANTICIPATION, ABIL119_STAKEOUT, ABIL119_STAKEOUT},         // PK505_WATCHOG = 0x1F9,
    //     { ABIL081_SNOW_CLOAK, ABIL113_SCRAPPY, ABIL146_SAND_RUSH},           // PK506_LILLIPUP = 0x1FA,
    //     { ABIL081_SNOW_CLOAK, ABIL113_SCRAPPY, ABIL146_SAND_RUSH},           // PK507_HERDIER = 0x1FB,
    //     { ABIL077_SLUSH_RUSH, ABIL113_SCRAPPY, ABIL146_SAND_RUSH},           // PK508_STOUTLAND = 0x1FC,
    //     { ABIL141_MOODY, ABIL158_PRANKSTER, ABIL097_SNIPER},                 // PK509_PURRLOIN = 0x1FD,
    //     { ABIL141_MOODY, ABIL158_PRANKSTER, ABIL097_SNIPER},                 // PK510_LIEPARD = 0x1FE,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK511_PANSAGE = 0x1FF,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION}, // PK512_SIMISAGE = 0x200,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},                // PK513_PANSEAR = 0x201,
    //     { ABIL070_DROUGHT, ABIL070_DROUGHT, ABIL070_DROUGHT},                // PK514_SIMISEAR = 0x202,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK515_PANPOUR = 0x203,
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK516_SIMIPOUR = 0x204,
    //     { ABIL036_TRACE, ABIL123_BAD_DREAMS, ABIL149_ILLUSION},              // PK517_MUNNA = 0x205,
    //     { ABIL036_TRACE, ABIL123_BAD_DREAMS, ABIL149_ILLUSION},              // PK518_MUSHARNA = 0x206,
    //     { ABIL097_SNIPER, ABIL100_TOUGH_CLAWS, ABIL100_TOUGH_CLAWS},                   // PK519_PIDOVE = 0x207,
    //     { ABIL097_SNIPER, ABIL100_TOUGH_CLAWS, ABIL100_TOUGH_CLAWS},                   // PK520_TRANQUILL = 0x208,
    //     { ABIL097_SNIPER, ABIL100_TOUGH_CLAWS, ABIL100_TOUGH_CLAWS},                   // PK521_UNFEZANT = 0x209,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK522_BLITZLE = 0x20A,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK523_ZEBSTRIKA = 0x20B,
    //     { ABIL045_SAND_STREAM, ABIL070_DROUGHT, ABIL106_AFTERMATH},          // PK524_ROGGENROLA = 0x20C,
    //     { ABIL045_SAND_STREAM, ABIL070_DROUGHT, ABIL106_AFTERMATH},          // PK525_BOLDORE = 0x20D,
    //     { ABIL045_SAND_STREAM, ABIL070_DROUGHT, ABIL106_AFTERMATH},          // PK526_GIGALITH = 0x20E,
    //     { ABIL141_MOODY, ABIL086_SIMPLE, ABIL086_SIMPLE},                    // PK527_WOOBAT = 0x20F,
    //     { ABIL141_MOODY, ABIL086_SIMPLE, ABIL086_SIMPLE},                    // PK528_SWOOBAT = 0x21{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL146_SAND_RUSH},        // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},9_DRILBUR = 0x211,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL146_SAND_RUSH},        // PK530_EXCADRILL = 0x212,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK531_AUDINO = 0x213,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK532_TIMBURR = 0x214,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK533_GURDURR = 0x215,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK534_CONKELDURR = 0x216,
    //     { ABIL107_ANTICIPATION, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK535_TYMPOLE = 0x217,
    //     { ABIL107_ANTICIPATION, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK536_PALPITOAD = 0x218,
    //     { ABIL107_ANTICIPATION, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK537_SEISMITOAD = 0x219,
    //     { ABIL107_ANTICIPATION, ABIL073_STRONG_BODY, ABIL113_SCRAPPY},   // PK538_THROH = 0x21A,
    //     { ABIL107_ANTICIPATION, ABIL073_STRONG_BODY, ABIL113_SCRAPPY},   // PK539_SAWK = 0x21B,
    //     { ABIL107_ANTICIPATION, ABIL034_CHLOROPHYLL, ABIL071_ARENA_TRAP},    // PK540_SEWADDLE = 0x21C,
    //     { ABIL107_ANTICIPATION, ABIL034_CHLOROPHYLL, ABIL071_ARENA_TRAP},    // PK541_SWADLOON = 0x21D,
    //     { ABIL107_ANTICIPATION, ABIL034_CHLOROPHYLL, ABIL071_ARENA_TRAP},    // PK542_LEAVANNY = 0x21E,
    //     { ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK543_VENIPEDE = 0x21F,
    //     { ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK544_WHIRLIPEDE = 0x22{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH, ABIL143_POISON_TOUCH}, // PK54{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},SCOLIPEDE = 0x221,
    //     { ABIL051_WIND_RIDER, ABIL027_EFFECT_SPORE, ABIL027_EFFECT_SPORE},       // PK546_COTTONEE = 0x222,
    //     { ABIL051_WIND_RIDER, ABIL027_EFFECT_SPORE, ABIL027_EFFECT_SPORE},       // PK547_WHIMSICOTT = 0x223,
    ...
    //     { ABIL119_STAKEOUT, ABIL093_STRONG_JAW, ABIL110_TINTED_LENS},       // PK553_KROOKODILE = 0x229,
    //     { ABIL070_DROUGHT, ABIL050_RUN_AWAY, ABIL050_RUN_AWAY},              // PK554_DARUMAKA = 0x22A,
    //     { ABIL070_DROUGHT, ABIL161_COLLECTIVE, ABIL161_COLLECTIVE},              // PK555_DARMANITAN = 0x22B,
    //     { ABIL008_SAND_VEIL, ABIL034_CHLOROPHYLL, ABIL045_SAND_STREAM},      // PK556_MARACTUS = 0x22C,
    //     { ABIL061_SHED_SKIN, ABIL084_UNBURDEN, ABIL005_STURDY},          // PK557_DWEBBLE = 0x22D,
    //     { ABIL061_SHED_SKIN, ABIL084_UNBURDEN, ABIL005_STURDY},          // PK558_CRUSTLE = 0x22E,
    //     { ABIL020_QUICK_DRAW, ABIL153_MOXIE, ABIL143_POISON_TOUCH},                 // PK559_SCRAGGY = 0x22F,
    //     { ABIL020_QUICK_DRAW, ABIL153_MOXIE, ABIL143_POISON_TOUCH},                 // PK560_SCRAFTY = 0x23{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL149_ILLUSION, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},           // PK5{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_SIGILYPH = 0x231,
    //     { ABIL045_SAND_STREAM, ABIL130_CURSED_BODY, ABIL023_SHADOW_TAG},        // PK562_YAMASK = 0x232,
    //     { ABIL045_SAND_STREAM, ABIL130_CURSED_BODY, ABIL023_SHADOW_TAG},        // PK563_COFAGRIGUS = 0x233,
    //     { ABIL045_SAND_STREAM, ABIL002_DRIZZLE, ABIL005_STURDY},             // PK564_TIRTOUGA = 0x234,
    //     { ABIL045_SAND_STREAM, ABIL002_DRIZZLE, ABIL005_STURDY},             // PK565_CARRACOSTA = 0x235,
    //     { ABIL022_INTIMIDATE, ABIL038_BERSERK, ABIL055_HUSTLE},              // PK566_ARCHEN = 0x236,
    //     { ABIL022_INTIMIDATE, ABIL038_BERSERK, ABIL055_HUSTLE},              // PK567_ARCHEOPS = 0x237,
    //     { ABIL001_STENCH, ABIL106_AFTERMATH, ABIL106_AFTERMATH},             // PK568_TRUBBISH = 0x238,
    //     { ABIL001_STENCH, ABIL106_AFTERMATH, ABIL106_AFTERMATH},             // PK569_GARBODOR = 0x239,
    //     { ABIL119_STAKEOUT, ABIL149_ILLUSION, ABIL149_ILLUSION},             // PK570_ZORUA = 0x23A,
    //     { ABIL119_STAKEOUT, ABIL149_ILLUSION, ABIL149_ILLUSION},             // PK571_ZOROARK = 0x23B,
    //     { ABIL158_PRANKSTER, ABIL158_PRANKSTER, ABIL158_PRANKSTER},          // PK572_MINCCINO = 0x23C,
    //     { ABIL158_PRANKSTER, ABIL158_PRANKSTER, ABIL158_PRANKSTER},          // PK573_CINCCINO = 0x23D,
    //     { ABIL023_SHADOW_TAG, ABIL149_ILLUSION, ABIL039_INNER_FOCUS},        // PK574_GOTHITA = 0x23E,
    //     { ABIL023_SHADOW_TAG, ABIL149_ILLUSION, ABIL039_INNER_FOCUS},        // PK575_GOTHORITA = 0x23F,
    //     { ABIL023_SHADOW_TAG, ABIL149_ILLUSION, ABIL039_INNER_FOCUS},        // PK576{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},OTHITELLE = 0x240,
    //     { ABIL036_TRACE, ABIL039_INNER_FOCUS, ABIL039_INNER_FOCUS},          // PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},7_SOLOSIS = 0x241,
    //     { ABIL036_TRACE, ABIL039_INNER_FOCUS, ABIL039_INNER_FOCUS},          // PK578_DUOSION = 0x242,
    //     { ABIL036_TRACE, ABIL039_INNER_FOCUS, ABIL039_INNER_FOCUS},          // PK579_REUNICLUS = 0x243,
    //     { ABIL002_DRIZZLE, ABIL081_SNOW_CLOAK, ABIL081_SNOW_CLOAK},          //  PK580_DUCKLETT = 0x244,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL081_SNOW_CLOAK},     //  PK581_SWANNA = 0x245,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL106_AFTERMATH},      //  PK582_VANILLITE = 0x246,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL106_AFTERMATH},      //  PK583_VANILLISH = 0x247,
    //     { ABIL117_SNOW_WARNING, ABIL081_SNOW_CLOAK, ABIL106_AFTERMATH},      //  PK584_VANILLUXE = 0x248,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK585_DEERLING = 0x249,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK586_SAWSBUCK = 0x24A,
    //     { ABIL057_PLUS, ABIL058_MINUS, ABIL009_STATIC},                       // PK587_EMOLGA = 0x24B,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL135_LIGHT_METAL}, //  PK588_KARRABLAST = 0x24C,
    //     { ABIL107_ANTICIPATION, ABIL107_ANTICIPATION, ABIL135_LIGHT_METAL}, //  PK589_ESCAVALIER = 0x24D,
    //     { ABIL119_STAKEOUT, ABIL027_EFFECT_SPORE, ABIL158_PRANKSTER},     // PK590_FOONGUS = 0x24E,
    //     { ABIL119_STAKEOUT, ABIL027_EFFECT_SPORE, ABIL158_PRANKSTER},     // PK591_AMOONGUSS = 0x24F,
    //     { ABIL002_DRIZZLE, ABIL023_SHADOW_TAG, ABIL130_CURSED_BODY},          //  PK5{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_FRILLISH = 0x250,
    //     { ABIL002_DRIZZLE, ABIL023_SHADOW_TAG, ABIL130_CURSED_BODY},          //   PK593_JELLICENT = 0x25{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL002_DRIZZLE, ABIL002_DRIZZLE, ABIL002_DRIZZLE},                // PK594_ALOMOMOLA = 0x252,
    //     { ABIL071_ARENA_TRAP, ABIL119_STAKEOUT, ABIL057_PLUS},               // PK595_JOLTIK = 0x253,
    //     { ABIL071_ARENA_TRAP, ABIL119_STAKEOUT, ABIL057_PLUS},               // PK596_GALVANTULA = 0x254,
    //     { ABIL106_AFTERMATH, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},    // PK597_FERROSEED = 0x255,
    //     { ABIL106_AFTERMATH, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},    // PK598_FERROTHORN = 0x256,
    //     { ABIL026_LEVITATE, ABIL057_PLUS, ABIL009_STATIC},                    // PK599_KLINK = 0x257,
    //     { ABIL026_LEVITATE, ABIL057_PLUS, ABIL009_STATIC},                    // PK600_KLANG = 0x258,
    //     { ABIL026_LEVITATE, ABIL057_PLUS, ABIL009_STATIC},                    // PK601_KLINKLANG = 0x259,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL009_STATIC},                    // PK602_TYNAMO = 0x25A,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL009_STATIC},                    // PK603_EELEKTRIK = 0x25B,
    //     { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL009_STATIC},                    // PK604_EELEKTROSS = 0x25C,
    //     { ABIL149_ILLUSION, ABIL036_TRACE, ABIL058_MINUS},                   // PK605_ELGYEM = 0x25D,
    //     { ABIL149_ILLUSION, ABIL036_TRACE, ABIL058_MINUS},                   // PK606_BEHEEYEM = 0x25E,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL070_DROUGHT},            //  PK607_LITWICK = 0x25F,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL070_DROUGHT},            //  PK{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},8_LAMPENT = 0x260,
    //     { ABIL149_ILLUSION, ABIL023_SHADOW_TAG, ABIL070_DROUGHT},            //  PK609_CHANDELURE = 0x26{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL110_TINTED_LENS, ABIL005_STURDY, ABIL083_ANGER_POINT},            // PK610_AXEW = 0x262,
    //     { ABIL110_TINTED_LENS, ABIL005_STURDY, ABIL083_ANGER_POINT},            //  PK611_FRAXURE = 0x263,
    //     { ABIL110_TINTED_LENS, ABIL005_STURDY, ABIL083_ANGER_POINT},            //  PK612_HAXORUS = 0x264,
    ...
    //     { ABIL107_ANTICIPATION, ABIL110_TINTED_LENS, ABIL097_SNIPER}, //   PK617_ACCELGOR = 0x269,
    //     { ABIL008_SAND_VEIL, ABIL045_SAND_STREAM, ABIL009_STATIC},      // PK618_STUNFISK = 0x26A,
    //     { ABIL107_ANTICIPATION, ABIL073_STRONG_BODY, ABIL073_STRONG_BODY},   // PK619_MIENFOO = 0x26B,
    //     { ABIL107_ANTICIPATION, ABIL073_STRONG_BODY, ABIL073_STRONG_BODY},   // PK620_MIENSHAO = 0x26C,
    //     { ABIL073_STRONG_BODY, ABIL116_SOLID_ROCK, ABIL116_SOLID_ROCK},      // PK621_DRUDDIGON = 0x26D,
    //     { ABIL045_SAND_STREAM, ABIL021_WELL_BAKED_BODY, ABIL106_AFTERMATH},        // PK622_GOLETT = 0x26E,
    //     { ABIL045_SAND_STREAM, ABIL021_WELL_BAKED_BODY, ABIL106_AFTERMATH},        // PK623_GOLURK = 0x26F,
    //     { ABIL003_SPEED_BOOST, ABIL119_STAKEOUT, ABIL119_STAKEOUT},          //  PK6{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_PAWNIARD = 0x270,
    //     { ABIL003_SPEED_BOOST, ABIL119_STAKEOUT, ABIL119_STAKEOUT},          // PK625_BISHARP = 0x27{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK626_BOUFFALANT = 0x272,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK627_RUFFLET = 0x273,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK628_BRAVIARY = 0x274,
    //     { ABIL119_STAKEOUT, ABIL008_SAND_VEIL, ABIL158_PRANKSTER},             // PK629_VULLABY = 0x275,
    //     { ABIL119_STAKEOUT, ABIL008_SAND_VEIL, ABIL158_PRANKSTER},             // PK630_MANDIBUZZ = 0x276,
    //     { ABIL071_ARENA_TRAP, ABIL070_DROUGHT, ABIL119_STAKEOUT},            //  PK631_HEATMOR = 0x277,
    //     { ABIL119_STAKEOUT, ABIL071_ARENA_TRAP, ABIL085_HEATPROOF},          // PK632_DURANT = 0x278,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                      // PK633_DEINO = 0x279,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                      // PK634_ZWEILOUS = 0x27A,
    //     { ABIL141_MOODY, ABIL141_MOODY, ABIL141_MOODY},                      // PK635_HYDREIGON = 0x27B,
    //     { ABIL070_DROUGHT, ABIL027_EFFECT_SPORE, ABIL001_STENCH},                 //  PK636_LARVESTA = 0x27C,
    //     { ABIL070_DROUGHT, ABIL027_EFFECT_SPORE, ABIL070_DROUGHT},                //  PK637_VOLCARONA = 0x27D,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK638_COBALION = 0x27E,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //  PK639_TERRAKION = 0x27F,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK6{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_VIRIZION = 0x280,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK641_TORNADUS = 0x281,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK642_THUNDURUS = 0x282,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK643_RESHIRAM = 0x283,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   //   PK644_ZEKROM = 0x284,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK645_LANDORUS = 0x285,
    //     { ABIL140_ICE_SCALES, ABIL038_BERSERK, ABIL001_STENCH},                   // PK646_KYUREM = 0x286,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK647_KELDEO = 0x287,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK648_MELOETTA = 0x288,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // PK649_GENESECT = 0x289,
    //     { ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},                   // MONSNO_MAX = 0x28A,
    // };

#pragma endregion

#pragma region Functions
    u8 isTeraItem(u16 teraItem){
...
#pragma region CriticalHitChanges
    ...
    */
    ...
    bool THUMB_BRANCH_ServerEvent_CheckCritical(ServerFlow *a1, BattleMon *a2, BattleMon *a3, int a4)
    {
        ...
        BattleEventVar_Push();
        BattleEventVar_SetConstValue(VAR_DEFENDING_MON, BattleMon_GetID(a3));
        BattleEventVar_SetConstValue(VAR_ATTACKING_MON, BattleMon_GetID(a2));
        BattleEventVar_SetValue(VAR_CRIT_STAGE, (PML_MoveGetParam(a4, MVDATA_CRIT_STAGE) + BattleMon_GetCritStage(a2)));
        v11 = 0;
...
#pragma region DamageCalc
    ...
    */
        ...
        _WORD *destDamage)
    {
        ...
        u8 Category;          // [sp+10h] [bp-20h]
        u16 power;             // [sp+14h] [bp-1Ch]
        u16 attack;            // [sp+18h] [bp-18h]
        u8 isAttackerMoldBreaker;

        Category = PML_MoveGetCategory(moveParam->MoveID);
        v29 = 0;
        BattleEventVar_Push();
        BattleEventVar_SetConstValue(VAR_TYPE_EFFECTIVENESS, TypeEffectiveness);
        BattleEventVar_SetConstValue(VAR_ATTACKING_MON, BattleMon_GetID(AttackingMon));
        BattleEventVar_SetConstValue(VAR_DEFENDING_MON, BattleMon_GetID(DefendingMon));
        ...
        else
        {
            ...
            weatherDmgRatio = WeatherPowerMod(ServerEvent_GetWeather(a1), moveParam->moveType);
            u8 atkAbil = BattleMon_GetValue(AttackingMon, VALUE_EFFECTIVE_ABILITY); 
            if (weatherDmgRatio != 4096) fxDamage = fixed_round(fxDamage, weatherDmgRatio);
            if (criticalFlag)
            {
                if (GetCritSetting() == 1 && !(PML_MoveGetParam(moveParam->MoveID, MVDATA_CRIT_STAGE) == 6))//SEARCH_ARRAY(autoCritMoves, moveParam->MoveID))
                {
                    fxDamage = fxDamage * 3;
                    fxDamage = fxDamage >> 1;
                }
            ...
            {
                if (BattleMon_CheckIfMoveCondition(AttackingMon, CONDITION_TERA) || isTeraItem(AttackingMon->HeldItem))//SEARCH_ARRAY(teraItems, AttackingMon->HeldItem))
                {
                    ...
                    {
                        ratio = (atkAbil == ABIL091_ADAPTABILITY) ? 9216 : 8192;

                    }
                    else if (moveType == teraType && atkAbil == ABIL091_ADAPTABILITY)
                    {
                        ratio = 8192;
                    }
            ...
            {
                if (atkAbil != ABIL109_UNAWARE){
                    v23 = (atkAbil == ABIL126_CONTRARY) ? v23 + (v23 >> 1) : (v23 >> 1);
                }
            }

            if ((BattleMon_GetValue(DefendingMon, VALUE_EFFECTIVE_ABILITY) == ABIL136_MULTISCALE || BattleMon_GetValue(DefendingMon, VALUE_EFFECTIVE_ABILITY) == ABIL129_MAJESTY) && !HasMoldBreaker(AttackingMon) && BattleMon_IsFullHP(DefendingMon))
            {
                v23 = 50 * v23 / 100u;
            }
            v23 = (!v23) ? 1 : v23;
...
#pragma region InterruptSwitches
    ...
    int THUMB_BRANCH_ServerEvent_InterruptSwitch(ServerFlow *a1, BattleMon *a2)
    {
        ...
        if (a1->actionOrderIndex)
        {
            ...
            do
            {
                ...
                if (BattleMon != a2 && !a1->actionOrderWork[v4].fDone)
                {
                    ...
                    {
                        if (MoveEvent_AddItem(a1->actionOrderWork[v4].BattleMon, v6, BattleMon_GetValue(BattleMon, VALUE_SPEED_STAT))) a1->actionOrderWork[v4].InterruptActive = 1;
                    }
        ...
        BattleEventVar_Push();
        BattleEventVar_SetConstValue(VAR_TARGET_MON_ID, BattleMon_GetID(a2));
...
#pragma region ExpandedTrainerPokemon
    ...
    void setTrPokAbility(PartyPkm *pkm, u8 genderAndAbil, u16 species, u32 form){
        ...
        {
            PokeParty_SetParam(pkm, PF_Ability, (abils >> 8) & 0xFF);
        }
        else if ((genderAndAbil & 0xF0) == 80)
        {
            PokeParty_SetParam(pkm, PF_Ability, (abils >> 16) & 0xFF);
        }
        else if ((genderAndAbil & 0xF0) == 96)
        {
            PokeParty_SetParam(pkm, PF_Ability, (abils >> 24) & 0xFF);
        }
        else
        {
            PokeParty_SetParam(pkm, PF_Ability, PML_PersonalGetParamSingle(species, form, Personal_Abil1));
...
#pragma region Block Passable
    ...
    int THUMB_BRANCH_BattleHandler_BatonPass(ServerFlow *a1, HandlerParam_BatonPass *a2)
    {
        ...
        if ( BattleMon_CheckIfMoveCondition(mon, CONDITION_GASTRO_ACID) )  ServerEvent_AbilityNullified(a1, v5);
    ...
    void THUMB_BRANCH_ServerControl_ClearMonDependentEffects(ServerFlow *a1, BattleMon *a2, int a3)
    {
        ...
        while ( FindFirstInParty_GetNext((void *)v9, a1, &a1a) )
        {
            if ( !BattleMon_GetConditionFlag(a2, CONDITIONFLAG_BATON_PASS) ){
                ...
                SCQueue_AddCommon(a1->serverCommandQueue, 44, BattleMon_GetID(a1a), ID);
            }
        }
