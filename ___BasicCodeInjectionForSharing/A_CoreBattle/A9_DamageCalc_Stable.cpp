...
#pragma region ConstLists
    ...
    const FourthAbility WhiteListedPokemon[651]{
        ...
        { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL016_BALLISTICS},          // PK007_SQUIRTLE = 0x7,
        { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL016_BALLISTICS},          // PK008_WARTORTLE = 0x8,
        { ABIL002_DRIZZLE, ABIL020_QUICK_DRAW, ABIL016_BALLISTICS},          // PK009_BLASTOISE = 0x9,
        ...
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK025_PIKACHU = 0x19,
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK026_RAICHU = 0x1A,
        ...
        { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL083_ANGER_POINT},      // PK031_NIDOQUEEN = 0x1F,
        ...
        { ABIL055_HUSTLE, ABIL083_ANGER_POINT, ABIL110_TENACITY},               // PK056_MANKEY = 0x38,
        { ABIL055_HUSTLE, ABIL083_ANGER_POINT, ABIL110_TENACITY},               // PK057_PRIMEAPE = 0x39,
        ...
        { ABIL070_DROUGHT, ABIL055_HUSTLE, ABIL032_SERENE_GRACE},            // PK078_RAPIDASH = 0x4E,
        ...
        { ABIL031_LIGHTNING_ROD, ABIL088_EXPLOIT, ABIL106_AFTERMATH},                   // PK100_VOLTORB = 0x64,
        { ABIL031_LIGHTNING_ROD, ABIL088_EXPLOIT, ABIL106_AFTERMATH},                   // PK101_ELECTRODE = 0x65,
        ...
        { ABIL055_HUSTLE, ABIL029_STRONG_BODY, ABIL113_SCRAPPY},         // PK106_HITMONLEE = 0x6A,
        { ABIL055_HUSTLE, ABIL029_STRONG_BODY, ABIL113_SCRAPPY},         // PK107_HITMONCHAN = 0x6B,
        ...
        { ABIL107_ANTICIPATION, ABIL070_DROUGHT, ABIL070_DROUGHT},           // PK136_FLAREON = 0x88,
        ...
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                    // PK172_PICHU = 0xAC,
        ...
        { ABIL057_PLUS, ABIL017_FLUFFY, ABIL058_MINUS},                   // PK181_AMPHAROS = 0xB5,
        ...
        { ABIL107_ANTICIPATION, ABIL119_STAKEOUT, ABIL149_ILLUSION},      // PK197_UMBREON = 0xC5,
        ...
        { ABIL045_SAND_STREAM, ABIL008_SAND_VEIL, ABIL008_SAND_VEIL},     // PK207_GLIGAR = 0xCF,
        ...
        { ABIL002_DRIZZLE, ABIL106_AFTERMATH, ABIL020_QUICK_DRAW},        // PK211_QWILFISH = 0xD3,
        { ABIL029_STRONG_BODY, ABIL005_STURDY, ABIL005_STURDY},           // PK212_SCIZOR = 0xD4,
        ...
        { ABIL026_LEVITATE, ABIL140_PERMAFROST, ABIL081_SNOW_CLOAK},           // PK225_DELIBIRD = 0xE{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
        ...
        { ABIL055_HUSTLE, ABIL029_STRONG_BODY, ABIL029_STRONG_BODY},      // PK236_TYROGUE = 0xEC,
        { ABIL055_HUSTLE, ABIL029_STRONG_BODY, ABIL029_STRONG_BODY},      // PK237_HITMONTOP = 0xED,
        ...
        { ABIL062_GUTS, ABIL029_STRONG_BODY, ABIL109_UNAWARE},               // PK287_SLAKOTH = 0x11F,
        { ABIL062_GUTS, ABIL029_STRONG_BODY, ABIL109_UNAWARE},               // PK2{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},_VIGOROTH = 0x120,
        { ABIL062_GUTS, ABIL029_STRONG_BODY, ABIL109_UNAWARE},               // PK289_SLAKING = 0x12{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
        ...
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK309_ELECTRIKE = 0x135,
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK310_MANECTRIC = 0x136,
        ...
        { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},      //  PK390_CHIMCHAR = 0x186,
        { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},      //  PK391_MONFERNO = 0x187,
        { ABIL070_DROUGHT, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},      //  PK392_INFERNAPE = 0x188,
        ...
        { ABIL069_DETERMINED, ABIL005_STURDY, ABIL146_SAND_RUSH},           // PK408_CRANIDOS = 0x198,
        { ABIL069_DETERMINED, ABIL005_STURDY, ABIL146_SAND_RUSH},           // PK409_RAMPARDOS = 0x199,
        ...
        { ABIL107_ANTICIPATION, ABIL110_TENACITY, ABIL027_EFFECT_SPORE}, //   PK414_MOTHIM = 0x19E,
        ...
        { ABIL033_SWIFT_SWIM, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},   //   PK453_CROAGUNK = 0x1C5,
        { ABIL033_SWIFT_SWIM, ABIL107_ANTICIPATION, ABIL107_ANTICIPATION},   //   PK454_TOXICROAK = 0x1C6,
        ...
        { ABIL058_MINUS, ABIL083_ANGER_POINT, ABIL042_MAGNET_PULL},                 // PK466_ELECTIVIRE = 0x1D2,
        ...
        { ABIL107_ANTICIPATION, ABIL029_STRONG_BODY, ABIL113_SCRAPPY},   // PK538_THROH = 0x21A,
        { ABIL107_ANTICIPATION, ABIL029_STRONG_BODY, ABIL113_SCRAPPY},   // PK539_SAWK = 0x21B,
        ...
        { ABIL020_QUICK_DRAW, ABIL153_MOXIE, ABIL153_MOXIE},                 // PK559_SCRAGGY = 0x22F,
        { ABIL020_QUICK_DRAW, ABIL153_MOXIE, ABIL153_MOXIE},                 // PK560_SCRAFTY = 0x23{ ABIL001_STENCH, ABIL001_STENCH, ABIL001_STENCH},
        ...
        { ABIL057_PLUS, ABIL058_MINUS, ABIL058_MINUS},                       // PK587_EMOLGA = 0x24B,
        ...
        { ABIL026_LEVITATE, ABIL057_PLUS, ABIL058_MINUS},                    // PK599_KLINK = 0x257,
        { ABIL026_LEVITATE, ABIL057_PLUS, ABIL058_MINUS},                    // PK600_KLANG = 0x258,
        { ABIL026_LEVITATE, ABIL057_PLUS, ABIL058_MINUS},                    // PK601_KLINKLANG = 0x259,
        { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK602_TYNAMO = 0x25A,
        { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK603_EELEKTRIK = 0x25B,
        { ABIL119_STAKEOUT, ABIL057_PLUS, ABIL058_MINUS},                    // PK604_EELEKTROSS = 0x25C,
        ...
        { ABIL110_TENACITY, ABIL005_STURDY, ABIL083_ANGER_POINT},            // PK610_AXEW = 0x262,
        { ABIL110_TENACITY, ABIL005_STURDY, ABIL083_ANGER_POINT},            //  PK611_FRAXURE = 0x263,
        { ABIL110_TENACITY, ABIL005_STURDY, ABIL083_ANGER_POINT},            //  PK612_HAXORUS = 0x264,
        ...
        { ABIL107_ANTICIPATION, ABIL110_TENACITY, ABIL097_SNIPER}, //   PK617_ACCELGOR = 0x269,
        ...
        { ABIL107_ANTICIPATION, ABIL029_STRONG_BODY, ABIL029_STRONG_BODY},   // PK620_MIENSHAO = 0x26C,
        { ABIL029_STRONG_BODY, ABIL116_SOLID_ROCK, ABIL116_SOLID_ROCK},      // PK621_DRUDDIGON = 0x26D,
        ...
        { ABIL140_PERMAFROST, ABIL038_BERSERK, ABIL001_STENCH},                   // PK646_KYUREM = 0x286,
    ...
    */
        ...
        _WORD *destDamage)
    {
        ...
        else
        {
            ...
            {
                if (BattleMon_GetValue(AttackingMon, VALUE_EFFECTIVE_ABILITY) != ABIL109_UNAWARE){
...
#pragma region ExpandedTrainerPokemon
    extern u32 __Waeabi_idiv(s32 numer, s32 denom);
