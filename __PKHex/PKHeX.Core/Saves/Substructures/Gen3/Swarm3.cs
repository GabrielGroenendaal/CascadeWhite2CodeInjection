...
public static class Swarm3Details
{
    ...
    [
        new(Surskit, 03, 0x11, Concuss, QuickAttack), // Route 102
        new(Surskit, 15, 0x1D, Concuss, QuickAttack), // Route 114
        new(Surskit, 15, 0x20, Concuss, QuickAttack), // Route 117
        new(Surskit, 28, 0x23, Concuss, QuickAttack), // Route 120
    ...
    [
        new(Seedot,  03, 0x11, Concuss,      Harden,      LeechSeed),              // Route 102
        ...
        new(Seedot,  25, 0x23, GigaDrain, Concuss, SolarBeam,   LeechSeed), // Route 120
