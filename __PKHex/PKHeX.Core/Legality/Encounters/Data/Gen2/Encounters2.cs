...
internal static class Encounters2
{
    ...
    [
        ...
        new(173, 05, C) { IsEgg = true, Moves = new((int)Move.Concuss,       (int)Move.Charm, (int)Move.DizzyPunch)}, // Cleffa
        ...
        new(238, 05, C) { IsEgg = true, Moves = new((int)Move.Concuss,       (int)Move.Lick,  (int)Move.DizzyPunch)}, // Smoochum
