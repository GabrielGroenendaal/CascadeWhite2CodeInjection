...
public class TrainerAIScriptFuncLibrary : ScriptFunctionLibrary
{
    ...
    public TrainerAIScriptFuncLibrary()
    {
        ...
        [
            ...
            null!, // 0x2B
#else
            new ScriptFuncMultiplyScore(), // 0x2B
#endif
            ...
            null!, // 0x3C
#else
            new ScriptFuncMultiplyScoreByStored(), // 0x3C
#endif
            ...
            null!, //0x3E
#else
            new ScriptFuncGetSimulationMultiplier(), // 0x3E
#endif
            ...
            null!, // 0x48
#else
            new ScriptFuncJumpIfUserWillFaint(), // 0x48
#endif
