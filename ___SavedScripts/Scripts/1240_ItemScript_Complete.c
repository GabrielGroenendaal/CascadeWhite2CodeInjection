...
/* TM18 Scorching Sands - Relic Castle (Upper Floors)*/
void Sequence2()
{
	LockAll();
...
/* Love Balls (x10) - Virbank Preschool */
void Sequence9()
{
	LockAll();
	SetVarEqVal(0x800C, 496);
...
/* Silverpowder - Virbank Complex (Outside) */
void Sequence19()
{
	LockAll();
...
/* CHARGESTONE CAVE 194 - Heart Scale */
void Sequence22()
{
	LockAll();
...
/* Light Ball - Castelia Battle Company */
void Sequence23()
{
	LockAll();
...
/* Thick Club - Castelia Battle Company */
void Sequence24()
{
	LockAll();
...
/* TM06 Magical Leaf - Castelia Gardens */
void Sequence28()
{
	LockAll();
...
/* TM33 Reflect - Relic Passage (Upper Floors) */
void Sequence30()
{
	LockAll();
...
/* Mental Herb x3 - Castelia Sewers */
void Sequence31()
{
	LockAll();
...
/* Lagging Tail - Castelia Sewers */
void Sequence32()
{
	LockAll();
	SetVarEqVal(0x800C, 279);
	SetVarEqVal(0x800D, 1);
	Sequence400();
	WaitMoment();
	UnlockAll();
...
/* RELIC PASSAGE WEST - Ultra Ball (x15) */
void Sequence44()
{
	LockAll();
...
/* Timer Ball (x3) - Castelia Battle Company */
void Sequence52()
{
	LockAll();
...
/* Fast Ball (x10) - Route 4 */
void Sequence53()
{
	LockAll();
	SetVarEqVal(0x800C, 492);
	SetVarEqVal(0x800D, 10);
	Sequence400();
	WaitMoment();
	UnlockAll();
...
/* Green Shards (x5) - Desert Resort (Inside) */
void Sequence54()
{
	LockAll();
	SetVarEqVal(0x800C, 75);
...
/* Scope Lens - Battle Company */
void Sequence55()
{
	LockAll();
	SetVarEqVal(0x800C, 232);
	SetVarEqVal(0x800D, 1);
	Sequence400();
	WaitMoment();
	UnlockAll();
...
/* TM84 Endure - Desert Resort (Inside) */
void Sequence57()
{
	LockAll();
...
/* Red Shards x5 - Desert Resort (Inside) */
void Sequence58()
{
	LockAll();
	SetVarEqVal(0x800C, 72);
...
/* Ultra Ball (x10) - Desert Resort (Inside) */
void Sequence59()
{
	LockAll();
	SetVarEqVal(0x800C, 2);
...
/* TM19 Giga Drain - Lostlorn Forest */
void Sequence65()
{
	LockAll();
...
/* Enigma Berry (X15) - Route 6 */
void Sequence73()
{
	LockAll();
	SetVarEqVal(0x800C, 208);
	SetVarEqVal(0x800D, 1);
	Sequence400();
	WaitMoment();
	UnlockAll();
...
/* MISTRALTON CAVE - TM07 Drain Punch */
void Sequence80()
{
	LockAll();
...
/* CHARGESTONE CAVE - TM72 Volt Switch */
void Sequence91()
{
	LockAll();
	SetVarEqVal(0x800C, 399);
	SetVarEqVal(0x800D, 1);
	Sequence400();
	WaitMoment();
	UnlockAll();
...
/* CHARGESTONE CAVE - TM36 Sludge Bomb */
void Sequence94()
{
	LockAll();
...
/* CELESTIAL TOWER - TM61 Will o WIsp */
void Sequence106()
{
	LockAll();
...
/* TM17 Hidden Force - Flocessy Town */
void Sequence224()
{
	LockAll();
...
/* Roseli Berry x 2 - Lostlorn Forest*/
void Sequence229()
{
	LockAll();
...
/* Focus Sash x2 - Driftveil Drawbridge (OUTDATED) */
void Sequence301()
{
	LockAll();
...
/* Ultra Ball x2 - Virbank Complex (Inside) */
void Sequence328()
{
	LockAll();
	SetVarEqVal(0x800C, 2);
...
/* Flame Orb - Virbank Complex (Inside) */
void Sequence329()
{
	LockAll();
	SetVarEqVal(0x800C, 273);
...
/* TM65 Shadow Claw - Pokestar Gate */
void Sequence332()
{
	LockAll();
...
/* Fire Stones x 10 - Relic Passage*/
void Sequence337()
{
	LockAll();
...
/* Dawn Stones x 10 - Relic Passage*/
void Sequence341()
{
	LockAll();
...
/* Moon Stones x 10 - Relic Passage*/
void Sequence342()
{
	LockAll();
	SetVarEqVal(0x800C, 81);
...
/* Shiny Stones x 10 - Relic Passage*/
void Sequence344()
{
	LockAll();
...
/* TM19 Giga Drain - Driftveil City */
void Sequence358()
{
	LockAll();
	SetVarEqVal(0x800C, 346);
...
void Sequence400()
{
	...
	PlaySound(1351);
	FacePlayer();
	SetVarEqVar(0x8008, 0x800C);
	SetVarEqVar(0x8009, 0x800D);
	CallGlobalScript(2808);
	CheckItemBagSpace(0x8008, 0x8009, 0x8020);
	c0x239(0x8021);
	StackPushVar(0x8020);
	StackPushConst(1);
	StackCompare(1);
	if (255) goto label0;
	GetNPCSpawnFlag(0x8011, 0x8010);
	SetFlag(0x8010);
	RemoveNPC(0x8011);
	ReturnAfterDelay(0);
	StackPushVar(0x8021);
...
{
	SetWordPlayerName(0);
	SetWordItem2(1, 0x8008, 0x8009, 1);
...
void Routine2()
{
	...
	if (255) goto label5;
	WaitMovement();
	CallGlobalScript(2810);

label5: ;
	WaitMessage();
	SetWordPlayerName(0);
	SetWordItem2(1, 0x8008, 0x8009, 0);
	SetWordItemPocket(2, 0x8008);
