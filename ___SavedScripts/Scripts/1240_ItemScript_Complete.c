...
/* RELIC PASSAGE WEST - TM91 Flash Cannon */
void Sequence45()
{
	LockAll();
...
/* TM39 Rock Tomb - Virbank Complex (Inside) */
void Sequence329()
{
	LockAll();
...
/* TM85 Grass Knot - Driftveil City */
void Sequence358()
{
	LockAll();
