...
enum ItemID
{
    ...
    IT0045_HP_UP = 0x2D,
    IT0046_PROTEIN = 0x2E,
    IT0047_UNUSUAL_CANDIES = 0x2F,
    IT0048_ABILITY_CAPSULE = 0x30,
    IT0049_CALCIUM = 0x31,
    IT0050_RARE_CANDIES = 0x32,
    IT0051_PP_UP = 0x33,
    IT0052_ABILITY_PATCH = 0x34,
    IT0053_PP_MAX = 0x35,
...
struct SWAN_PACKED SWAN_ALIGNED(4) BtlClientWk_Test
{
    MainModule *mainModule;
    PokeCon *pokeCon;
    BattleMon *procPoke;
